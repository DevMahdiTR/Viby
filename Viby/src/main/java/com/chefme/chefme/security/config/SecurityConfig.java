package com.chefme.chefme.security.config;


import com.chefme.chefme.security.jwt.JWTAuthenticationFilter;
import com.chefme.chefme.security.jwt.JwtAuthEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/point_record/**").permitAll()
